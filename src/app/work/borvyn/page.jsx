  ...
  return (
    <div className="sample-project" ref={sampleProjectRef}>
      ...
      <section className="sp-banner-img">
        <img src="/images/work/borvyn/1.webp" alt="" />
      </section>
        ...
        <div className="sp-info">
          ...
          <div className="sp-col sp-col-sm">
            ...
            <div className="client">
              <Copy delay={0.3}>
                <p className="sm caps mono">Borvyn Bakery</p>
              </Copy>
            </div>
          </div>
        </div>
      ...
      <section className="sp-images">
        ...
        <div className="sp-images-container">
          <div className="sp-img">
            <img src="/images/work/borvyn/1.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/borvyn/2.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/borvyn/3.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/borvyn/4.png" alt="" />
          </div>
          <div className="sp-img">
            <img src="/images/work/borvyn/5.png" alt="" />
          </div>
        </div>
      </section>
